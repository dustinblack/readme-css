                ...
                <tr>
                    ...
                    <td><details><summary>flatten (<code>bool<code>[test]</code></code>)</summary>
                        <table><tbody style="width: 100%">
                            ...
                            <tr>
                                <th>Description:</th>
                                <td width=500>Processes the metrics first into a two-dimensional format via the pcp2csv converter, and then converts the CSV to JSON, effectively flattening the data structure. This is useful when indexing metrics to a service like Elasticsearch.</td>
                            </tr>
                        </tbody></table>
                    </details></td>
                </tr>
